...
var map = {
	"./coachDetail/coachDetail.module": [
		"./src/app/coachDetail/coachDetail.module.ts",
		"coachDetail-coachDetail-module"
	],
	"./coachs/coachs.module": [
...
var routes = [
    ...
    {
        path: "coachs",
        loadChildren: "./coachs/coachs.module#CoachsModule"
    },
    {
        path: "coachDetail",
        loadChildren: "./coachDetail/coachDetail.module#CoachDetailModule",
        data: {}
    },
    {
        path: "toto",
        loadChildren: "./toto/toto.module#TotoPageModule"
    }
];
...
module.exports = __webpack_require__(/*! /Users/ludwig/myApp/src/main.ts */"./src/main.ts");
